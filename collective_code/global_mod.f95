...
integer :: ini_seed                                             ! Random seed
integer :: seed_size
integer , dimension(:) , allocatable :: ini_seed_arr
integer , dimension(:) , allocatable :: seed
real(kind=dp) :: seed_tr
integer , dimension(:,:) , allocatable :: mt
integer , dimension(:) , allocatable :: mti
integer , parameter :: N = 624, N1 = N + 1
integer , parameter :: nn = 345342763
...
integer(kind=dp) :: iTotS                                       ! Total number of S
...
real(kind=dp) :: z_width                                        ! Width of z slice, concentration fields
integer , dimension(:) , allocatable :: react_box
...
real(kind=dp) :: Ms                                             ! Mass of one B particle
...
real(kind=dp) :: EsC                                            ! Reduced LJ Potential of S with C
real(kind=dp) :: EaN                                            ! Reduced LJ Potential of A with N
real(kind=dp) :: EbN                                            ! Reduced LJ Potential of B with N
real(kind=dp) :: EsN                                            ! Reduced LJ Potential of S with N
real(kind=dp) :: x_conc_slab                                    ! 2D concentration field yz-slab, x pos.
real(kind=dp) :: y_conc_slab                                    ! 2D concentration field xz-slab, y pos.
real(kind=dp) :: z_conc_slab                                    ! 2D concentration field xy-slab, z pos.
real(kind=dp) :: Ew                                             ! LJ sphere-wall distance parameter
real(kind=dp) :: Rw                                             ! LJ sphere-wall potential parameter
real(kind=dp) :: Em                                             ! LJ motor-motor potential parameter
real(kind=dp) :: Rm_delta                                       ! Motor-motor LJ extra distance parameter
real(kind=dp) :: T                                              ! Reduced temperature
real(kind=dp) :: varA                                           ! Variance of A vel. Gauss. distr.
real(kind=dp) :: varB                                           ! Variance of B vel. Gauss. distr.
real(kind=dp) :: varS                                           ! Variance of S vel. Gauss. distr.
...
integer(kind=dp) , parameter :: MaxS=100
integer(kind=dp) , dimension(:) , allocatable :: tACellN        ! Total number of A solvent in cell N
integer(kind=dp) , dimension(:) , allocatable :: tBCellN        ! Total number of B solvent in cell N
integer(kind=dp) , dimension(:) , allocatable :: tSCellN        ! Total number of S solvent in cell N
integer(kind=dp) , dimension(:,:) , allocatable :: sACellN      ! Label A in Cell N with i
integer(kind=dp) , dimension(:,:) , allocatable :: sBCellN      ! Label B in Cell N with i
integer(kind=dp) , dimension(:,:) , allocatable :: sSCellN      ! Label S in Cell N with i
...
real(kind=dp) :: k1                                             ! Back reaction A -> S
...
real(kind=dp) , dimension(:,:) , allocatable :: concA2d_xy
real(kind=dp) , dimension(:,:) , allocatable :: concB2d_xy
real(kind=dp) , dimension(:,:) , allocatable :: concA2d_xz
real(kind=dp) , dimension(:,:) , allocatable :: concB2d_xz
real(kind=dp) , dimension(:,:) , allocatable :: concA2d_yz
real(kind=dp) , dimension(:,:) , allocatable :: concB2d_yz
