...
!
!***********************************************************************
! Fortran version rewritten as an F90 module and mt state saving and
! getting
...
!    integer, save, dimension(:,:) , allocatable :: mt
!    integer, save, dimension(:) , allocatable   :: mti
...
!
    ...
    integer, dimension(0:N-1) , intent(inout) :: mt
...
!         state information will be written in formatted form.
  subroutine mtsavef( mt, mti, fname, forma )

!NOTE: This subroutine APPENDS to the end of the file "fname".

    character(*), intent(in) :: fname
    character, intent(in)    :: forma
    integer , dimension(:,:) , intent(in) :: mt
    integer , dimension(:) , intent(in) :: mti
    ...
    select case (forma)
      ...
      case default
       open(unit=10,file=trim(fname),status='REPLACE',form='FORMATTED',&
            position='APPEND')
       write(10,*)mti
       write(10,*)mt
  ...
  subroutine mtsaveu( mt, mti, unum, forma )
...
! where   format_character = 'u' or 'U' will read in unformatted form,
! otherwise
!         state information will be read in formatted form.
  subroutine mtgetf( mt, mti, fname, forma )

    character(*), intent(in) :: fname
    character, intent(in)    :: forma
    integer , dimension(:,:) , intent(out) :: mt
    integer , dimension(:) , intent(out) :: mti
  ...
  subroutine mtgetu( mt, mti, unum, forma )
