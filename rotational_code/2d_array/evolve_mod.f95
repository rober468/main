...
!$OMP PARALLEL DO DEFAULT(NONE)&
!$OMP SHARED(sphere,nt,box,flag,xsol,ysol,zsol,xdim,ydim,zdim,fpairx,fpairy,fpairz) &
...
do k = 1,numdims
 ...
 call LJ_force(sphere(1),NT,Box,flag,Xsol,Ysol,Zsol,Xdim(k,1),Ydim(k,1),Zdim(k,1),FpairX(k,1,:),FpairY(k,1,:), &
 ...
 call LJ_force(sphere(2),NT,Box,flag,Xsol,Ysol,Zsol,Xdim(k,2),Ydim(k,2),Zdim(k,2),FpairX(k,2,:),FpairY(k,2,:), &
