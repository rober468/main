...
do i = 1,NT
 ...
 if ( dR(1)*dR(1) + dR(2)*dR(2) + dR(3)*dR(3) <= (cutoff+skinrad)**2 ) then
...
allocate(outside_particle_part(num_threads,(2*NT/num_threads)))
allocate(inside_particle_num_part(num_threads))
allocate(inside_particle_part(num_threads,(2*NT/num_threads)))

outside_particle_num_part = 0
inside_particle_num_part = 0
outside_particle_part = 0
inside_particle_part = 0
